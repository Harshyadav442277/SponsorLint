...
Expected verdict: **3 FAIL · 0 WARN · 4 PASS · 1 MANUAL PENDING → 4/7 → DO NOT SEND**
...
Expected verdict: **0 FAIL · 7 PASS · 1 MANUAL PENDING → 7/7 automated → REVIEW**

Before approving either take, verify that the fictional Aegis interface remains visible for at
least five seconds, then check **Confirmed manually** in the review screen. The current real V3
shows only a static logo, so the committed approved sample leaves this item unchecked and correctly
resolves to `REVIEW`.
